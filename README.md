...
## Changes
This version of the kata is in C#.

## Doing the kata
You can do the kata in two different ways:

* Do only the refactoring by starting with a stub that includes tests.
* Write the tests for the requirements and then start refactoring.
